...
const domToCsv = tablesForAHome => {
	...
	return `${address}	${listingPrice}	${sellingPrice}	${daysOnMarket}	${numBeds}	${numBaths}	${numParkingSpots}`;
};
...
const header = 'Address  	Listing Price 	Selling Price 	Days on market 	Beds 	Baths 	Parking spots';
csvs.unshift(header);
